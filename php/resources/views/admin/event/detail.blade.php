        ...
        <div class="row">
            <div class="col-md-10">
                <div class="panel panel-primary">
                    <div class="panel-heading">活動編輯</div>
                    <div class="panel-body">
                        <form action="{{ route('admin.event.update', $data->id) }}" class="form-horizontal" method="post" id="form_add_event_products">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group has-feedback {{ $errors->has('coupon') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="coupon" id="coupon" {{ $options['can_edit'] === true ? '' : 'disabled' }} value="{{ old('coupon') ?? $data->coupon }}">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group has-feedback {{ $errors->has('content.description') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="content[description]" id="content_description" placeholder="請輸入活動說明文字" value="">
                                                    <span class="glyphicon form-control-feedback"></span>
                            ...
                            <div class="form-group has-feedback {{ $errors->has('started_at') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group timepicker">
                                        <input type="text" class="form-control" name="started_at" id="started_at" value="{{ old('started_at') ?? $data->started_at }}">
                            ...
                            <div class="form-group has-feedback {{ $errors->has('expired_at') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group timepicker">
                                        <input type="text" class="form-control" name="expired_at" id="expired_at" value="{{ old('expired_at') ?? $data->expired_at }}">
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
...
@push('js')
    ...
    <script>
        ...
        if (content !== '') {
            //to paste original infos
            pastedExistedEventInfos(content)
        }
